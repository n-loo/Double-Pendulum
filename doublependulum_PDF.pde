...
color one = #e91e63;    //color of pendulum path

void setup() {
    frameRate(60);
    size(1000, 1000, PDF, "doublependulum.pdf"); //saves to PDF (can convert to svg illustrator)
    pg = createGraphics(width, height);
    pg.beginDraw();
    pg.background(255,255,255,0); //background color 
    pg.endDraw();
}
